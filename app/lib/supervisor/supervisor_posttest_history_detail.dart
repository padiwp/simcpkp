...
class SupervisorPostTestHistoryDetail extends StatefulWidget {
  const SupervisorPostTestHistoryDetail({
    super.key,
  ...
  @override
  State<SupervisorPostTestHistoryDetail> createState() =>
      _SupervisorPreTestHistoryDetailState();
}

class _SupervisorPreTestHistoryDetailState
    extends State<SupervisorPostTestHistoryDetail> {
