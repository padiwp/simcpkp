...
class SupervisorPreTestHistoryDetail extends StatefulWidget {
  const SupervisorPreTestHistoryDetail({
    super.key,
  ...
  @override
  State<SupervisorPreTestHistoryDetail> createState() =>
      _SupervisorPreTestHistoryDetailState();
}

class _SupervisorPreTestHistoryDetailState
    extends State<SupervisorPreTestHistoryDetail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Detail Riwayat Pre Test'),
      ),
      body: ListView(
        ...
        children: [
          ...
          Text(
            int.parse(widget.accuracy.split('.')[0]) < 90
                ? 'TIDAK LULUS'
                : 'LULUS',
            style: TextStyle(
