import 'package:app/nurse/nurse_posttest_history_detail.dart';

import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
// Import halaman detail

class NursePostTestHistoryList extends StatefulWidget {
  const NursePostTestHistoryList({
    super.key,
  ...
  @override
  State<NursePostTestHistoryList> createState() =>
      _NursePostTestHistoryListState();
}

class _NursePostTestHistoryListState extends State<NursePostTestHistoryList> {
  @override
              ...
              return ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => NursePostTestHistoryDetail(
