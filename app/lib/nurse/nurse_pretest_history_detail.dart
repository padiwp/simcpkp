...
class NursePreTestHistoryDetail extends StatefulWidget {
  const NursePreTestHistoryDetail({
    super.key,
  ...
  @override
  State<NursePreTestHistoryDetail> createState() =>
      _NursePreTestHistoryDetailState();
}

class _NursePreTestHistoryDetailState extends State<NursePreTestHistoryDetail> {
