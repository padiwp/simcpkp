...
class AllPreTestHistoryList extends StatefulWidget {
  const AllPreTestHistoryList({
    super.key,
  ...
  @override
  State<AllPreTestHistoryList> createState() => _AllPreTestHistoryListState();
}

class _AllPreTestHistoryListState extends State<AllPreTestHistoryList> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: const Text('Semua Riwayat Pre Test'),
      ),
      body: StreamBuilder(
