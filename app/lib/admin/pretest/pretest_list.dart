...
class PreTestList extends StatefulWidget {
  final String userId;
  final String role;
  ...
  @override
  State<PreTestList> createState() => _PreTestListState();
}

class _PreTestListState extends State<PreTestList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Daftar Pre Test'),
      ),
