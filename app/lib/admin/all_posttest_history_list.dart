...
class AllPostTestHistoryList extends StatefulWidget {
  const AllPostTestHistoryList({
    super.key,
  ...
  @override
  State<AllPostTestHistoryList> createState() => _AllPostTestHistoryListState();
}

class _AllPostTestHistoryListState extends State<AllPostTestHistoryList> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: const Text('Semua Riwayat Post Test'),
      ),
      body: StreamBuilder(
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                subtitle: Text('Nilai: ${document['accuracy']}'),
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
