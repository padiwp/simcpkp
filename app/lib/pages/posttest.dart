import 'package:app/admin/all_posttest_history_list.dart';
import 'package:app/nurse/nurse_posttest_history_list.dart';
import 'package:app/pages/quiz_posttest_confirmation.dart';
import 'package:app/supervisor/supervisor_posttest_history_list.dart';
...
class _PostTestState extends State<PostTest> {
  ...
  bool isPostTestCompleted = false;
            ...
            onPressed: () {
              if (widget.role == "Penyelia") {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => SupervisorPostTestHistoryList(
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => NursePostTestHistoryList(
                      examinee: widget.examinee,
                      role: widget.role,
                      userId: widget.userId,
                    ),
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => AllPostTestHistoryList(
                      examinee: widget.examinee,
                      role: widget.role,
                      userId: widget.userId,
                    ),
      ...
      child: InkWell(
        onTap: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => QuizPostTestConfirmation(
                examinee: widget.examinee,
                role: widget.role,
                userId: widget.userId,
                testId: testId,
