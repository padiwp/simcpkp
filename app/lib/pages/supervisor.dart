...
class Penyelia extends StatefulWidget {
  final String role; // Tambahkan variabel role
  const Penyelia({super.key, required this.role});

  @override
  State<Penyelia> createState() => _UserState();
}

class _UserState extends State<Penyelia> {
